...
% Enforce every section to start on a brand new page
...
\definecolor{githubgreen}{RGB}{106,153,85}
...
\begin{table}[ht]
    \centering
    \begin{tabular}{|L{3.0cm}|L{3.4cm}|L{8.0cm}|}
        \hline
...
\begin{table}[ht]
    \centering
    \begin{tabular}{|L{4.0cm}|C{1.8cm}|C{2.3cm}|L{6.2cm}|}
        \hline
...
\begin{table}[ht]
    \centering
    \begin{tabular}{|L{2.4cm}|L{6.2cm}|L{3.4cm}|C{2.4cm}|}
        \hline
...
\begin{table}[ht]
    \centering
    \begin{tabular}{|L{3.6cm}|C{2.0cm}|C{2.2cm}|C{1.8cm}|C{2.8cm}|}
        \hline
...
\begin{table}[ht]
    \centering
    \begin{tabular}{|L{3.5cm}|L{2.5cm}|C{1.8cm}|C{2.2cm}|C{2.6cm}|}
        \hline
...
\begin{table}[ht]
    \centering
    \begin{tabular}{|L{4.6cm}|C{2.1cm}|C{2.1cm}|C{1.8cm}|C{2.2cm}|}
        \hline
...
\begin{table}[ht]
    \centering
    \begin{tabular}{|L{3.0cm}|C{1.6cm}|L{2.2cm}|L{2.2cm}|C{1.6cm}|R{2.3cm}|}
        \hline
